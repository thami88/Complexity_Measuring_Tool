	...
	<nav
		...
		<div class="collapse navbar-collapse" id="basicExampleNav">
			...
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item"><a class="nav-link" href="ControlStructures.jsp">ComplexityCS</a></li>
				<li class="nav-item active"><a class="nav-link" href="SizeVariable.jsp">Complexity Size<span class="sr-only">(current)</span></a></li>
